    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        for (var i = 0; i < tempFilePaths.length; i++) {
          ...
          //图片路径可自行修改
          uploadImage(res.tempFilePaths[i], 'landlord_mini/user/' + g_uid + '/cert/houseCard/' ,
            function (result) {
              ...
              wx.showLoading({
                ...
                success: function (res) {
                  ...
                  console.log(deedImg, deedNum, 'deedImg')
                },
                fail: function (res) { },
                complete: function (res) { },
              })
              ...
              wx.showLoading({
                ...
                success: function (res) {
                  ...
                  if (idCardNum == 2) {
                    ...
                    console.log(imgList, idCardNum,'imgList')
                  }
                  else if (idCardNum == 3) {
                    var imgList1 = avatar;
                    var idCardNum1=idCardNum
                    that.setData({
                      imgList1: imgList1,
                      idCardNum1: idCardNum1,
                    })
                    console.log(imgList1, idCardNum1, 'imgList1')
                  }
                },
                fail: function (res) { },
                complete: function (res) { },
